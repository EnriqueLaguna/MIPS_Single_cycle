...
add wave -noupdate -expand -group ADDRESS -radix hexadecimal /MIPS_Processor_TB/DUV/ROM/address_i
add wave -noupdate -expand -group ADDRESS -radix hexadecimal /MIPS_Processor_TB/DUV/ROM/instruction_o
add wave -noupdate -expand -group ADDRESS -radix hexadecimal /MIPS_Processor_TB/DUV/ROM/real_address_mask_w
add wave -noupdate -expand -group ADDRESS -radix hexadecimal /MIPS_Processor_TB/DUV/ROM/real_address_r
add wave -noupdate -expand -group ADDRESS -radix decimal /MIPS_Processor_TB/DUV/ROM/rom
